...
import { PaginationProps, IState, ISearchDataBasic } from '~/interfaces/interfaces';
import './Pagination.css';

const Pagination: React.FC<PaginationProps> = ({ data }: { data: ISearchDataBasic }) => {
