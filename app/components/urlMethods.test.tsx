...
describe('Location Data Functions', () => {
  ...
  it('should return an error message when Pokémon ID is valid but already in pokemonData', async () => {
    const result = await returnPokemonData('2', { '1': 'bulbasaur' });
    expect(result).toBe('No results found'); // No fetch should happen, and thus no data returned
  });
});
